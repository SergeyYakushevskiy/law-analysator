...
from src.infrastructure.config.core import META_FILE_NAME_DEFAULT
from src.infrastructure.parser.document import ParsedDocument
from src.infrastructure.parser.parser import DocumentParser


class MetadataRepository(MetadataRepositoryPort):

    def __init__(self, project_path: Path):
        self.meta_path = project_path / META_FILE_NAME_DEFAULT
